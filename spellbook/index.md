...
- [Single-Task Oath and 3-Item Rule](#task-hydra-rituals) - choose the head, limit the list.
- [Tide Marks and First Bites](#temporal-shark-rituals) - make time visible before the fin appears.
...
## Task Hydra Rituals {#task-hydra-rituals}
...
## Temporal Shark Rituals {#temporal-shark-rituals}
...
## Slumber Troll Rituals {#slumber-troll-rituals}
...
## Cave Bear Rituals {#cave-bear-rituals}

**Threshold Spell**
- Stand in the doorway, breathe, and face the light.
- Take three breaths, three moves: sit up -> feet down -> stand -> walk to water -> splash face.

**Rope of Returning**
- Text an ally: "Pull me out in 10?"
- Set a timer; when it rings, step outside the cave and reply with a quick selfie or voice note.

**Hibernation with a Clock**
- If you rest, set a 20-90 minute timer.
- Name your wake-up action before lying down (for example, "When it rings, I open blinds and drink water.")

[Leave the cave with gentle activation.]({{ '/monsters/cave-bear/' | relative_url }})

---

## Dopamine Goblin Rituals {#dopamine-goblin-rituals}
...
- Make the reward immediate and small (tea, meme, stretch, fresh song).
